...
function Navbar() {
    ...
    // Apply theme changes when light state changes
    useEffect(() => {
      if (light) {
            ...
            <div id="navbarBasicExample" className="navbar-menu">
                ...
                <div className="navbar-item">
                    <div className="buttons">
                        ...
                        <button className="button is-primary icon-text" onClick={changeTheme}>       
                            <span className="icon">
                            {isLightTheme? <i className="zmdi zmdi-sun"></i> :  <i className="zmdi zmdi-brightness-2 has-text-primary-dark" ></i>}
